...
--
-- Host: localhost    Database: evideo_org_ua
-- ------------------------------------------------------
...
--
-- Table structure for table `oc_rating_index`
--

DROP TABLE IF EXISTS `oc_rating_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_rating_index` (
...
--
-- Dumping data for table `oc_rating_index`
--

LOCK TABLES `oc_rating_index` WRITE;
/*!40000 ALTER TABLE `oc_rating_index` DISABLE KEYS */;
INSERT INTO `oc_rating_index` VALUES (0,18,50),(0,25,42),(0,33,30),(0,34,32),(0,46,50);
/*!40000 ALTER TABLE `oc_rating_index` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-04-07 13:51:27
